      ...
      <img width="500" src="/img/bck.png" />
       ...
       En iyi aoijs botlarından biri olan Keyblade AOİJS artık tik aldı.Sizlere teşekkürlerimizi iletiyoruz. 
        ...
        <div className="animateHeader mt-10 flex flex-wrap items-center justify-center gap-x-4">
            ...
            <Link href={"https://discord.com/oauth2/authorize?client_id=1118497331357159470&scope=bot&permissions=8"}>
              <a
                className={
      ...
      <div className="flex flex-row w-full h-auto lg:h-56 my-14 lg:my-40 bg-gradient-to-br lg:px-30 from-neutral-900/90 flex items-center justify-start to-neutral-900/50 rounded-lg p-1 shadow-md">
              <>
                <div className="lg:mx-4 lg:p-8 py-4 lg:py-16 flex items-center justify-center flex-col text-center w-full lg:w-auto lg:text-left lg:flex-none">
                  <img src="https://cdn.discordapp.com/attachments/1074024121077338285/1180415765787193394/Screenshot_20231202_105036.jpg?ex=657d56d9&is=656ae1d9&hm=9f9011740195451c40f07ac301670443ef3af74cf62c6df4604d0bf396c6f762&"  width="256" className="lg:hidden rounded-xl mb-5 shadow-xl shadow-black" />
